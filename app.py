...
st.title('Streamlit Lite App')

num = st.text_input('Enter phone number:')
...
if st.button('Submit'):
    ...
    response_text2 = response1.text

    st.write('Response from Patch Request:')
    st.write(response_text1)
    st.write('Response from Post Request:')
