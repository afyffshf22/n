...
st.title('Moakt Inbox Extender')
st.write('This application extends the inbox session every 30 minutes.')

if st.button('Start Extending Inbox Session'):
    st.write('Started extending the inbox session.')
